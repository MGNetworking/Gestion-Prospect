...
class ProspectTest {
    ...
    @Test
    @DisplayName("Interet regex pour OUI")
    void exceptionSetInteretFormatOUITest(){
        assertThrows(ExceptionPersonnaliser.class,
            ()-> prospect.setInteresse("oui"), "=> prospect interet regex : oui");
    }
    @Test
    @DisplayName("Interet regex pour NON")
    void exceptionSetInteretFormatNONTest(){
        assertThrows(ExceptionPersonnaliser.class,
            ()-> prospect.setInteresse("non"), "=> prospect interet regex : non");
    }
}
